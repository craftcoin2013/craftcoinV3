...
example /usr/src/craftcoin, AND not under, for example, /mnt/d/craftcoin. 
...
way. This will install to `c:\workspace\craftcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/craftcoin
