CraftCoin Core version 1.14.6 is now available from:

  <https://github.com/craftcoin/craftcoin/releases/tag/v1.14.6/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/craftcoin/craftcoin/issues>

To receive notifications about updates, subscribe to the release mailing list:

  <https://sourceforge.net/projects/craftcoin/lists/craftcoin-releases>

Releases are also announced on reddit:

  <https://www.reddit.com/r/craftcoindev/>
...
```
craftcoin-cli addnode <address> remove
```
...
```
craftcoin-cli liststucktransactions
```
...
```
craftcoin-cli setmaxconnections <desired_amount>
```
...
```
craftcoin-cli rescan <start_block>
```
