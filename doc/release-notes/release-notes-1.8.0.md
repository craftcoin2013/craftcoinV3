...
use "craftcoind" you must run it the first time with the "-reindex" command line
option.
...
assigned numbers. DIP standards can be found at https://github.com/craftcoin/dips/ .
...
A problem in parsing mangled craftcoin: URIs under Windows has been resolved, and as
part of this work network detection for craftcoin: URIs is now more robust.
