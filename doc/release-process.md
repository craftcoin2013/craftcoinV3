...
space _do not upload these to the craftcoin.com server, nor put them in the torrent_.
...
- Create a [new GitHub release](https://github.com/CraftCoinProj/craftcoinV3/releases/new) with a link to the archived release notes.
