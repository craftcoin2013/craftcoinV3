...
* Discuss on [#craftcoin-dev](http://webchat.freenode.net/?channels=craftcoin-dev) on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=craftcoin-dev).
