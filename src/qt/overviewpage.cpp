...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the CraftCoin Core repository on GitHub"),
        tr("Services that claim to double your craftcoin are always ponzi schemes")
    };
