...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s craftcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  craftcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded craftcoin transaction") + "\n" +
              "  craftcoin-tx [options] -create [commands]   " + _("Create hex-encoded craftcoin transaction") + "\n" +
              "\n";
