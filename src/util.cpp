...
const char * const BITCOIN_CONF_FILENAME = "craftcoin.conf";
const char * const BITCOIN_PID_FILENAME = "craftcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CraftCoin";
#else
    // Unix
