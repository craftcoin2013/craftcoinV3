...
/*
 * craftcoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * craftcoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * CraftCoin: Get a fee targetting a specific transaction speed.
     */
