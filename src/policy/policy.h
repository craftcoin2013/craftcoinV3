 ...
 *
 *  craftcoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * craftcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * craftcoin: Default hard dust limit that is evaluated when considering whether
