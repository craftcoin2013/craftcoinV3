...
This means one can have an always-on craftcoind instance running, and another local craftcoind/craftcoin-qt instance which connects to this node and receives blocks from it.
